...
/**
 * This is an event that is fired when an entity takes lethal damage and opportunities to evade death have been
 * exhausted.
 *
 * @author Sugaku
 */
public class VerifiedDeathEvent extends EntityEvent implements Cancellable { // todo: Refactor for PlayerManager to use.
     ...
     */
    public VerifiedDeathEvent (AdvancedDamageEvent advancedDamageEvent) {
